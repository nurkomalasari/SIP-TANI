...
<head>
  ...
  <title>Halaman Kategori Pestisida</title>
  <!-- Favicon -->
          ...
          <div class="row align-items-center py-4">
            <div class="col-lg-11 col-12">
              ...
              <div class="card-action">
                <a href="{{url('/mitra/tambah_kategori')}}" class="btn btn-success btn-sm"><i class="fa fa-plus p-r-5">  TAMBAH OBAT</i></a>
              </div>
              <br>
              <div class="row">
                <div class="col-md-12">
                ...
                <table class="table table-light" id="datatables">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/kategori/edit/{{ $k->id }}"class="btn btn-success" ><i class="fa fa-edit"></i></a>
