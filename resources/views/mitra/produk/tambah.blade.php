...
<head>
  ...
  <title>Tambah Produk Pestisida</title>
  <!-- Favicon -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-11 col-12">
              <h6 class="h2 text-white d-inline-block mb-0">Tambah Data Obat Pestisida</h6>
              ...
              <form method="post" action="{{ url('/mitra/produk/store') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group" >
                    <label for="example-text-input" class="form-control-label">Nama Produk Pestisida</label>
                    <input class="form-control" type="text"  name="nama_pupuk" placeholder="nama obat pestisida">
                </div>
                <div class="form-group">
                    <b>Gambar Pupuk</b><br/>
                ...
                <textarea class="form-control" id="deskripsi" name="deskripsi_obat" rows="4"></textarea>
                </div>
                <div class="form-group" >
                ...
                <div class="form-group" >
                    ...
                    <input class="form-control" type="text"  name="keunggulan" placeholder="keunggulan obat pestisida">
                </div>
                <div class="form-group">
                <label for="komposisi">Komposisi Obat Pestisida</label>
                <textarea class="form-control" id="komposisi" name="komposisi" rows="4"></textarea>
                </div>
                <div class="form-group">
                <label for="penggunaan">Penggunaan Obat Pestisida</label>
                <textarea class="form-control" id="penggunaan" name="penggunaan" rows="4"></textarea>
                </div>
                <div class="form-group">
