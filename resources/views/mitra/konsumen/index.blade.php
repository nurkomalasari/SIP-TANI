      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="{{url('/konsumen')}}">
          ...
          <div class="row align-items-center py-4">
            <div class="col-lg-12 col-13">
              ...
              {{-- <div class="card-action">
                <a href="{{url('/mitra/ta')}}" class="btn btn-success btn-sm"><i class="fa fa-plus p-r-5">  TAMBAH OBAT</i></a>
              </div> --}}
              <br>
              <div class="row">
                <div class="col-md-12">
                ...
                <table class="table table-light" id="datatables">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/konsumen/edit/{{ $k->id }}"class="btn btn-success" ><i class="fa fa-edit"></i></a>
                                <a href="/konsumen/delete/{{ $k->id }}"class="btn btn-danger"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
