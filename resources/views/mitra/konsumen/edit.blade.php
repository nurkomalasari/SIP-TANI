        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-11 col-12">
              ...
              <form method="post" action="{{ url('/konsumen/update/'. $konsumen->id) }}" >
                ...
                <input type="text" name="nama" class="form-control" placeholder="Nama Konsumen" value="{{$konsumen->nama}}">
                        @if($errors->has('name'))
                ...
                <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="Email" value="{{$konsumen->email}}" >
                        @if($errors->has('email'))
                            <div class="text-danger">
                                {{ $errors->first('email')}}
                            </div>
                ...
                <div class="form-group">
                        ...
                        <input type="hidden" name="password" class="form-control" placeholder="Password" value="{{$konsumen->password}}" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="noKtp" class="form-control" placeholder="Nomer Ktp" value="{{$konsumen->noKtp}}">
                        @if($errors->has('noKtp'))
                            <div class="text-danger">
                                {{ $errors->first('noKtp')}}
                            </div>
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="alamat" class="form-control" placeholder="Alamat" value="{{$konsumen->alamat}}">
                ...
                <div class="form-group">
                        ...
                        <input type="number" name="noHp" class="form-control" placeholder="No Hp" value="{{$konsumen->noHp}}">
                        @if($errors->has('noHp'))
                            <div class="text-danger">
                                {{ $errors->first('noHp')}}
                            </div>
